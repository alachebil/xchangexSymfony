...
class Categorie extends \App\Entity\Categorie implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Categorie' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Categorie' . "\0" . 'nomCategorie', '' . "\0" . 'App\\Entity\\Categorie' . "\0" . 'produit'];
        }
     ...
     * {@inheritDoc}
     */
    public function setNomCategorie(?string $nomCategorie): \App\Entity\Categorie
    {
