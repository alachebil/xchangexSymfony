 ...
 */
class getReductionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReductionRepository' shared autowired service.
     *
     * @return \App\Repository\ReductionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReductionRepository.php';

        return $container->privates['App\\Repository\\ReductionRepository'] = new \App\Repository\ReductionRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
