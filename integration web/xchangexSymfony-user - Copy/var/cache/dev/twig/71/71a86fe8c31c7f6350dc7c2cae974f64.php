...
class __TwigTemplate_23c31b631f4acaffe7080bae86250fef extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 13
        if ((isset($context["sms_response"]) || array_key_exists("sms_response", $context) ? $context["sms_response"] : (function () { throw new RuntimeError('Variable "sms_response" does not exist.', 13, $this->source); })())) {
            // line 14
            echo "\t\t\t\t\t\t\t<div>";
            echo twig_escape_filter($this->env, (isset($context["sms_response"]) || array_key_exists("sms_response", $context) ? $context["sms_response"] : (function () { throw new RuntimeError('Variable "sms_response" does not exist.', 14, $this->source); })()), "html", null, true);
            echo "</div>
\t\t\t\t\t\t";
        }
    ...
    {
        return array (  108 => 14,  106 => 13,  102 => 12,  97 => 10,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
\t\t\t\t\t\t{% endif %}
{% endblock %}
", "reclamation/edit.html.twig", "C:\\xampp\\htdocs\\integration web\\xchangexSymfony-user - Copy\\templates\\reclamation\\edit.html.twig");
    }
}
