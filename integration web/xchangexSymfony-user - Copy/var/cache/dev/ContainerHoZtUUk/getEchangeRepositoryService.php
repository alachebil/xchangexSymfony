 ...
 */
class getEchangeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EchangeRepository' shared autowired service.
     *
     * @return \App\Repository\EchangeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EchangeRepository.php';

        return $container->privates['App\\Repository\\EchangeRepository'] = new \App\Repository\EchangeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
