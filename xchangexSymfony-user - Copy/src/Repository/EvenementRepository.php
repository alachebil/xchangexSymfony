...
class EvenementRepository extends ServiceEntityRepository
{
    ...
    { 
        ...
        $query = $entityManager->createQuery(' SELECT e.nomEvent as  nom,e.idEvent as id, count(e.idEvent) as count FROM App\Entity\Evenement e JOIN App\Entity\Participation p where e.idEvent = p.idEvenement group by e.idEvent' );
