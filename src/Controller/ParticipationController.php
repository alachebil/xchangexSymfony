...
class ParticipationController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager,Evenement $idevent,MailerService $mailer): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $to= $client->getEmail();
            $nom= $client->getNom();
            $nomEvent=$idevent->getNomEvent();
            //$dateEvent=$idevent->getDate();
        $mailer->sendEmail($to,$nom,$nomEvent/*,$dateEvent*/);
            
            $entityManager->flush();
            $this->addFlash('success', 'Votre participation de l\'événement '.$idevent->getNomEvent().' a été enregistrée avec succès!');
